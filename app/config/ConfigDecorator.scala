...
class ConfigDecorator @Inject() (
  ...
  lazy val viewPaymentHistory: String = s"$childBenefitViewFrontend/view-payment-history"

  lazy val viewProofEntitlement: String = s"$childBenefitViewFrontend/view-proof-entitlement"
