...
class AddressController @Inject() (
  ...
  def taxCreditsChoice = ProtectedAction(addressBreadcrumb) { implicit pertaxContext =>
  ...
  def processTaxCreditsChoice = ProtectedAction(addressBreadcrumb) { implicit pertaxContext =>
    addressJourneyEnforcer { payeAccount => personalDetails =>
  ...
  def residencyChoice = ProtectedAction(addressBreadcrumb) { implicit pertaxContext =>
    addressJourneyEnforcer { payeAccount => personDetails =>
  ...
  def processResidencyChoice: Action[AnyContent] = ProtectedAction(addressBreadcrumb) { implicit pertaxContext =>
    addressJourneyEnforcer { payeAccount => personDetails =>
  ...
  def showPostcodeLookupForm(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
      addressJourneyEnforcer { payeAccount => personDetails =>
  ...
  def showAddressSelectorForm(typ: AddrType, postcode: String, filter: Option[String], back: Option[Boolean] = None): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
  ...
  def showUpdateAddressForm(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
  ...
  def processUpdateAddressForm(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
      gettingCachedJourneyData[Result](typ) { journeyData =>
        val showEnterAddressHeader = journeyData.addressLookupServiceDown || journeyData.selectedAddressRecord == None
  ...
  def enterStartDate(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
      addressJourneyEnforcer { payeAccount => personDetails =>
  ...
  def processEnterStartDate(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
      addressJourneyEnforcer { payeAccount => personDetails =>
        nonPostalJourneyEnforcer(typ) {
  ...
  def reviewChanges(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
      addressJourneyEnforcer { payeAccount => personDetails =>
        nonPostalJourneyEnforcer(typ) {
  ...
  def submitChanges(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
  ...
  def showAddressAlreadyUpdated(typ: AddrType): Action[AnyContent] = ProtectedAction(addressBreadcrumb) {
    implicit pertaxContext =>
      addressJourneyEnforcer { payeAccount => personDetails =>
