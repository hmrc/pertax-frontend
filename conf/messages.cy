...
label.you_can_access_your_ni_record_from_sp_summary=Gallwch gael mynediad at eich cofnod Yswiriant Gwladol o grynodeb eich Pensiwn y Wladwriaeth.
...
label.apply_for_home_responsibilities_protection=Gwneud cais am Ddiogelwch Cyfrifoldebau Cartref
label.apply_for_national_insurance_class_three_credits=Gwneud cais am gredydau Yswiriant Gwladol Dosbarth 3
label.apply_for_credits_for_parents_and_carers=Gwneud cais am gredydau ar gyfer rhieni a gofalwyr
label.apply_for_refund_of_class_two_ni_contributions=Gwneud cais am ad-daliad o gyfraniadau Yswiriant Gwladol Dosbarth 2
label.apply_for_refund_of_class_four_ni_contributions=Gwneud cais am ad-daliad o gyfraniadau Yswiriant Gwladol Dosbarth 4
label.apply_for_deferment_of_payment_class_one_ni_contributions=Gwneud cais i ohirio talu cyfraniadau Yswiriant Gwladol Dosbarth 1
label.apply_for_european_healthcare_certificate=	Gwneud cais am dystysgrif Gofal Iechyd Ewropeaidd
label.find_out_about_self_employment_and_temporary_work_in_another_country=Dysgwch ragor am hunangyflogaeth a gweithio dros dro mewn gwlad arall o fewn yr Ardal Economaidd Ewropeaidd (EEU)
