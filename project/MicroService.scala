...
trait MicroService {
  ...
  lazy val microservice = Project(appName, file("."))
    ...
    .settings(
      ...
      TwirlKeys.templateImports ++= Seq("models._", "models.dto._", "controllers.bindable._", "uk.gov.hmrc.domain._", "util.TemplateFunctions._", "uk.gov.hmrc.http.HeaderCarrier"),
