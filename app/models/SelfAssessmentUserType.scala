...
object SelfAssessmentUserType {
  ...
  private val activatedSa    = ActivatedOnlineFilerSelfAssessmentUser.toString
  private val notActivatedSa = NotYetActivatedOnlineFilerSelfAssessmentUser.toString
  private val wrongCredsSa   = WrongCredentialsSelfAssessmentUser.toString
  private val notEnrolledSa  = NotEnrolledSelfAssessmentUser.toString
  private val nonFilerSa     = NonFilerSelfAssessmentUser.toString

  implicit val writes: Writes[SelfAssessmentUserType] = {
  ...
  implicit val reads: Reads[SelfAssessmentUserType] = (json: JsValue) =>
