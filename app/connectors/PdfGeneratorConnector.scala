...
@Singleton
class FrontendPdfGeneratorConnector @Inject() (val mode:Mode, val runModeConfiguration: Configuration, wsHttp: WsAllMethods) extends PdfGeneratorConnector with ServicesConfig {
