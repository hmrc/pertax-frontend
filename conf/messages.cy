...
label.your_income_tax=Your Income Tax in the {0} to {1} tax year
...
label.check_to_see_if_you_paid_the_right_amount_of_tax_from_=Check to see if you paid the right amount of tax from 6 April {0} to 5 April {1}.
...
label.you_do_not_owe_hmrc_anything=You do not owe HMRC anything.
...
label.to_continue_to_receive_a_welsh_language_service_=Er mwyn parhau i gael gwasanaeth Gymraeg, dylech anfon e-bost i gwasanaeth.cymraeg@hmrc.gsi.gov.uk neu roi galwad ffôn i ni ar y rhif uchod.
...
label.you_can_download_and_use_the_hmrc_app_or_go_online_to=Gallwch lawrlwytho a defnyddio ap CThEM, neu fynd ar-lein, er mwyn:
label.create_and_access_your_personal_tax_account=creu a chyrchu’ch Cyfrif Treth Personol
label.update_and_track_your_tax_information_online=diweddaru ac olrhain eich manylion treth ar-lein
label.check_if_you_are_due_a_tax_refund=gwirio a oes ad-daliad treth yn ddyledus i chi
label.view_your_tax_code=gweld eich cod treth
