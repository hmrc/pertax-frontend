...
label.your_address_has_been_saved=Mae''ch cyfeiriad wedi''i gadw
...
label.third_line_of_your_address=Trydedd linell eich cyfeiriad
label.fourth_line_of_your_address=Pedwaredd linell eich cyfeiriad
label.fifth_line_of_your_address=Pumed linell eich cyfeiriad
...
label.phone_lines_are_less_busy_before_10am_monday-to_friday=Mae llinellau ffôn yn llai prysur cyn 10:00 ar ddydd Llun i ddydd Gwener.
...
label.if_you_entered_the_correct_date_contact_HMRC_=Os nodwyd y dyddiad cywir gennych, <a href="{0}" target="_blank"> cysylltwch â CThEM (yn agor ffenestr newydd)</a> i ddiweddaru''ch cyfeiriad.
...
label.you_cannot_currently_see_your_self_assessment_=Ni allwch weld eich manylion Hunanasesiad ar-lein ar hyn o bryd.<br /><br /><a href="{0}" target="_blank">Anfon eich Ffurflen Dreth drwy''r post (yn agor ffenestr newydd)</a>.
...
label.sign_in_with_the_user_id_you_used_or_created_=Mewngofnodwch gyda''r Dynodydd Defnyddiwr a ddefnyddiwyd neu a grëwyd gennych pan wnaethoch ymuno â Hunanasesiad.<br /><br />Gallwch <a href="{0}" target="_blank">adfer eich Dynodydd Defnyddiwr (yn agor ffenestr newydd)</a> os ydych wedi''i anghofio.
label.you_cant_currently_see_your_self_assessment_online_=Ni allwch weld eich manylion Hunanasesiad ar-lein ar hyn o bryd. Felly, <a href="{0}" target="_blank">anfonwch eich Ffurflen Dreth drwy''r post (yn agor ffenestr newydd)</a>yn ôl yr arfer.
...
label.if_you_have_query_contact_HMRC=Os oes gennych gwestiwn, gallwch <a href="{0}" target="_blank">gysylltu â Chyllid a Thollau EM (yn agor ffenestr newydd)</a> i gael help.
...
label.cant_confirm_identity_and_have_query_contact_HMRC=Os na allwch roi prawf o bwy ydych, ac mae gennych gwestiwn, gallwch <a href="{0}" target="_blank">gysylltu â Chyllid a Thollau EM (yn agor ffenestr newydd)</a> i gael help.
...
label.this_helps_us_work_out_your_correct_rate_of_income_tax_=Mae hyn yn ein helpu i gyfrifo''r gyfradd gywir o Dreth Incwm ar eich cyfer. O 6 Ebrill 2016 ymlaen, byddwch yn talu cyfradd yr Alban o Dreth Incwm os ydych yn byw yn yr Alban. Os ydych yn symud i''r Alban, neu o''r Alban, yn ystod blwyddyn dreth, neu''n byw mewn mwy nag un cartref, mae''n bosibl y bydd eich sefyllfa''n wahanol. <a class="ga-track-event" data-ga-event-category="link - click" data-ga-event-action="Why do you need to know this?" data-ga-event-label="Check if you''ll pay the Scottish rate of Income Tax (opens in a new window)" href="{0}" target="_blank">Gwirio a fyddwch yn talu cyfradd yr Alban o Dreth Incwm (yn agor ffenestr newydd)</a>.
label.whats_my_main_home=Beth yw fy mhrif gartref?
label.your_main_home_is_usually_where_you_live_=<p>Fel arfer, eich prif gartref yw ble''r ydych yn byw ac yn treulio''ch amser yn bennaf. Nid yw o bwys a ydych yn berchen arno, yn ei rentu neu''n byw ynddo yn rhad ac am ddim.</p><p>Mae''n bosibl mai''ch prif gartref yw''r cartref lle''r ydych yn treulio llai o amser os dyna ble:</p><ul class="list-bullet"><li>mae''r rhan fwyaf o''ch eiddo</li><li>mae''ch teulu''n byw</li><li>rydych wedi''ch cofrestru ar gyfer pethau fel eich cyfrif banc, eich meddyg teulu neu''ch yswiriant car</li><li>rydych yn aelod o glybiau neu gymdeithasau</li></ul><p>O 6 Ebrill 2016 ymlaen, byddwch yn talu cyfradd yr Alban o Dreth Incwm os ydych yn byw yn yr Alban. Os ydych yn symud i''r Alban, neu o''r Alban, yn ystod blwyddyn dreth, neu''n byw mewn mwy nag un cartref, mae''n bosibl y bydd eich sefyllfa''n wahanol. <a class="ga-track-event" data-ga-event-category="link - click" data-ga-event-action="What''s my main home?" data-ga-event-label="Check if you''ll pay the Scottish rate of Income Tax (opens in a new window)" href="{0}" target="_blank">Gwirio a fyddwch yn talu cyfradd yr Alban o Dreth Incwm (yn agor ffenestr newydd)</a>.</p>
...
label.next_steps=Camau nesaf
label.if_youve_moved_to_or_from_scotland_=Os ydych wedi symud i''r Alban, neu o''r Alban, rhown wybod i chi os oes newid i''ch cod treth.
...
text.if_you_dont_claim_child_benefit_=Os nad ydych yn hawlio Budd-dal Plant, rydych fel arfer yn gymwys ar ei gyfer os ydych yn gyfrifol am blentyn sydd o dan 16 oed (neu o dan 20 oed os yw''n aros mewn addysg neu hyfforddiant cymeradwy), ac rydych yn byw yn y DU. <a class="trackLink" href="{0}" target="_blank">Gwiriwch a allwch hawlio Budd-dal Plant (yn agor ffenestr newydd)</a>
...
text.has_any_other_change_in_their_circumstances=os oes unrhyw newidiadau eraill yn amgylchiadau eich plentyn
