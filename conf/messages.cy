...
selfAssessment.tax.info.1 = System y mae CThEF yn ei defnyddio i gasglu Treth Incwm yw Hunanasesiad.
selfAssessment.tax.info.2 = Fel arfer, didynnir treth yn awtomatig oddi wrth gyflogau a phensiynau. Os oes gan bobl a busnesau incwm arall, mae’n rhaid iddynt roi gwybod amdano mewn Ffurflen Dreth Hunanasesiad.
selfAssessment.tax.info.3 = Gallwch wirio
selfAssessment.CheckTaxReturn.linkText = a oes angen i chi anfon Ffurflen Dreth
selfAssessment.tax.info.4 = os nad ydych yn siŵr, neu
