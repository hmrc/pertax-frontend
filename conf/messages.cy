...
label.if_you_do_not_live_in_the_uk_=Os nad ydych y byw yn y DU, <a href="{0}" target="_blank" rel="noopener noreferrer">llenwch y ffurflen ‘Notification of a change in personal details’ i ddiweddaru’ch cyfeiriad (yn agor ffenestr neu dab newydd – Saesneg yn unig)</a>.
