...
label.your_national_insurance_and_state_pension=Eich Yswiriant Gwladol a’ch Pensiwn y Wladwriaeth
label.you_pay_national_insurance_contributions=Rydych yn talu cyfraniadau Yswiriant Gwladol er mwyn bod yn gymwys am fudd-daliadau penodol a’ch Pensiwn y Wladwriaeth.
label.your_state_pension_and_national_insurance_record=Crynodeb o’ch Pensiwn y Wladwriaeth a’ch cofnod Yswiriant Gwladol
label.view_your_state_pension_summary_to_find_out=Bwrw golwg dros eich Pensiwn y Wladwriaeth i gael gwybod:
label.when_you_get_your_state_pension=pryd y gallwch gael eich Pensiwn y Wladwriaeth
label.how_much_you_can_get=faint y gallwch ei gael
label.if_you_can_increase_it=os gallwch ei gynyddu
label.view_your_national_insurance_record_to_find_out=Bwrw golwg dros eich cofnod Yswiriant Gwladol i gael gwybod:
label.what_youve_paid_up_to_current_tax_year=yr hyn yr ydych wedi’i dalu, hyd at ddechrau’r flwyddyn dreth bresennol
label.if_youve_received_any_national_insurance_credits=os ydych wedi cael unrhyw gredydau Yswiriant Gwladol
label.view_your_state_pension_summary=Bwrw golwg dros grynodeb o’ch Pensiwn y Wladwriaeth
label.view_your_national_insurance_summary=Bwrw golwg dros eich cofnod Yswiriant Gwladol
...
label.save_your_number_to_the_wallet_app_on_your_apple_phone=cadw eich rhif Yswiriant Gwladol i’r waled ar eich ffôn clyfar, neu oriawr glyfar
...
label.second_line_of_your_address_optional=Ail linell eich cyfeiriad (opsiynol)
...
label.what_if_i_live_in_scotland=Beth os ydw i’n byw yn yr Alban?
label.scottish_tax_info=O 6 Ebrill 2016 ymlaen, byddwch yn talu cyfradd yr Alban o Dreth Incwm os ydych yn byw yn yr Alban. Os ydych yn symud i’r Alban, neu o’r Alban, yn ystod blwyddyn dreth, neu os ydych yn byw mewn mwy nag un tŷ,
label.scottish_tax_info_link=gwiriwch a oes angen i chi dalu cyfradd yr Alban o Dreth Incwm (yn agor tab newydd)
...
label.todays_date_warning=Byddwch yn gweld dyddiad heddiw os yw’r dyddiad a nodwyd gennych yn gynharach na’r un sydd ar gofnod gan CThEF. Ni fydd hyn yn effeithio ar eich treth.
...
head.error.line4OrTown_required=Nodwch dref neu ddinas
head.error.postcode_required=Nodwch y cod post
...
error.line4OrTown_required=Nodwch dref neu ddinas
error.postcode_required=Nodwch y cod post
...
head.error.line4OrTown_contains_more_than_35_characters=Tref neu ddinas: mae’n rhaid i hyn fod yn 35 o gymeriadau neu lai
...
error.line4OrTown_contains_more_than_35_characters=Tref neu ddinas: mae’n rhaid i hyn fod yn 35 o gymeriadau neu lai
...
head.error.line4OrTown_invalid_characters=Gwirio y dref neu ddinas
...
error.line4OrTown_invalid_characters=Gall eich cyfeiriad gynnwys llythrennau a i z, rhifau, bylchau, cysylltnodau (-), collnodau (’), comas (,), blaenslaesys (/), atalnodau llawn (.), ampersandau (&) a chromfachau crwn.
...
error.address_doesnt_exist_try_to_enter_manually=Nid oedd modd i ni ddod o hyd i unrhyw gyfeiriadau ar gyfer {0}. Nodwch god post sy’n hysbys, neu nodwch y cyfeiriad â llaw.
head.error.address_doesnt_exist_try_to_enter_manually=Nid oedd modd i ni ddod o hyd i unrhyw gyfeiriadau ar gyfer {0}. Nodwch god post sy’n hysbys, neu nodwch y cyfeiriad â llaw.
...
newLabel.hmrc_owes_you_a_refund=Mae CThEF yn ddyledus ad-daliad o £{0} i chi ar gyfer y flwyddyn {1} i {2}
...
newLabel.you_owe=Mae arnoch £{0} ar gyfer blwyddyn dreth {1} i {2}
...
news.childBenefitExtension.content=<p class="govuk-body">Dylai rhieni a gofalwyr sydd am barhau i gael Budd-dal Plant weithredu cyn 30 Tachwedd i gael eu hawliad llawn.</p><p class="govuk-body">Os gwnaethoch fethu'r dyddiad cau o 31 Awst bydd eich taliadau Budd-dal Plant yn dod i ben yn awtomatig. Fodd bynnag, gellir ailgychwyn hawliadau a gellir ôl-ddyddio taliadau am hyd at dri mis.</p><p class="govuk-body">Os yw person ifanc rhwng 16 a 19 oed yn parhau ag addysg amser llawn nad yw'n addysg uwch neu hyfforddiant cymeradwy (gan gynnwys astudio gartref oherwydd salwch neu anabledd), gall Budd-dal Plant barhau.</p><p class="govuk-body">Gallwch wneud cais ar-lein i <a class="govuk-link" href="https://www.gov.uk/child-benefit-16-19">ymestyn eich Budd-dal Plant</a>.</p><p class="govuk-body">Os ydych chi'n ennill dros £60,000 y flwyddyn, neu os yw'ch partner yn ennill mwy na hynny, bydd yn rhaid i chi dalu'r Tâl Treth Budd-dal Plant Incwm Uchel o hyd. Gallwch nawr dalu'r tâl drwy eich cod treth TWE.</p>
