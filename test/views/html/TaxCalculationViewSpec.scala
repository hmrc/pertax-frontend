  ...
  "taxCalculation" should {
    ...
    "give the correct heading" when {
      ...
      "status is Underpaid PaidAll" in {
        ...
        assertContainsText(view(status), messages("label.you_do_not_owe_any_more_tax", "2017", "2018"))
      }
      ...
      "status is Underpaid PaymentDue" in {
        ...
        assertContainsText(view(status), messages("label.you_paid_too_little_tax", "2017", "2018"))
      }
      ...
      "status is Underpaid PaymentDue and SA deadline has passed" in {
        ...
        assertContainsText(view(status), messages("label.you_missed_the_deadline_to_pay_your_tax", "2017", "2018"))
      }
      ...
      "status is Overpaid Refund" in {
        ...
        assertContainsText(view(status), messages("label.you_paid_too_much_tax", "2017", "2018"))
      }
    ...
    "display the correct content" when {
      ...
      "status is UnderpaidPaymentDue" in {
        ...
        assertContainsText(view(status), messages("label.you_owe_hmrc", "100.00"))
        assertContainsLink(view(status), messages("label.make_a_payment"), makePaymentUrl)
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_little"), underpaidUrlReasons)
      }
      ...
      "status is UnderpaidPaymentDue with due date" in {
        ...
        assertContainsText(view(status), messages("label.you_owe_hmrc_you_must_pay_by_", "100.00", s"${formatDate(date)}"))
        assertContainsLink(view(status), messages("label.make_a_payment"), makePaymentUrl)
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_little"), underpaidUrlReasons)
      }
      ...
      "status is Underpaid PaymentDue with due date and sa date has passed" in {
        ...
        assertContainsText(view(status), messages("label.you_owe_hmrc_you_should_have_paid_", "100.00", s"${formatDate(date)}"))
        assertContainsLink(view(status), messages("label.make_a_payment"), makePaymentUrl)
      }
      ...
      "status is Underpaid PartPaid with due date" in {
        ...
        assertContainsText(view(status), messages("label.you_still_owe_hmrc_you_must_pay_by_", "100.00", s"${formatDate(date)}"))
        assertContainsLink(view(status), messages("label.make_a_payment"), makePaymentUrl)
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_little"), underpaidUrlReasons)
      }
      ...
      "status is Underpaid PartPaid with due date and sa date has passed" in {
        ...
        assertContainsText(view(status), messages("label.you_still_owe_hmrc_you_should_have_paid_", "100.00", s"${formatDate(date)}"))
        assertContainsLink(view(status), messages("label.make_a_payment"), makePaymentUrl)
      }
      ...
      "status is Underpaid PaidAll" in {
        ...
        assertContainsText(view(status), messages("label.you_have_no_payments_to_make_to_hmrc"))
      }
      ...
      "status is Overpaid Refund" in {
        ...
        assertContainsText(view(status), messages("label.hmrc_owes_you_a_refund", "100.00"))
        assertContainsLink(view(status), messages("label.claim_your_tax_refund"), taxcalcUrl)
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_much"), overpaidUrlReasons)
      }
      ...
      "status is Overpaid PaymentProcessing" in {
        ...
        assertContainsText(view(status), messages("label.hmrc_is_processing_your_refund", "100.00"))
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_much"), overpaidUrlReasons)
      }
      ...
      "status is Overpaid PaymentPaid" in {
        ...
        assertContainsText(view(status), messages("label.hmrc_has_paid_your_refund", "100.00"))
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_much"), overpaidUrlReasons)
      }
      ...
      "status is Overpaid PaymentChequeSent" in {
        ...
        assertContainsText(view(status), messages("label.hmrc_sent_you_a_cheque_for", "100.00"))
        assertContainsLink(view(status), messages("label.find_out_why_you_paid_too_much"), overpaidUrlReasons)
      }
